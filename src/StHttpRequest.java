...
public class StHttpRequest {
	 ...
	 */
	public int sendGetRequest(String url) throws IOException, OAuthMessageSignerException,
			OAuthExpectationFailedException, OAuthCommunicationException {
		...
		try {
			...
			if (200 == responseCode || 401 == responseCode || 403 == responseCode || 404 == responseCode) {
